    ...
    <div className="my-4 mx-2">
      <div className="flex flex-col md:flex-row w-full items-center justify-between">
        <div className="flex flex-col gap-4 md:w-[60%] w-full">
          <h1 className="font-body text-title text-4xl text-center md:text-start md:mb-4 md:text-5xl">
            Who We Are
          </h1>
      ...
      <div className="flex items-center justify-center md:justify-normal">
        <button className="bg-transparent border-2 border-black px-12 mx-2 text-black font-body text-lg py-2 rounded-2xl mt-4">
          Join Now
        </button>
      </div>
    </div>
